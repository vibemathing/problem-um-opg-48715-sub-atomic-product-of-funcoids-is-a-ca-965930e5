...
```json
{
  ...
  "attempts": [
    {
      "artifacts": [],
      "attempt_id": "attempt:um-opg-48715-sub-atomic-product-of-funcoids-is-a-ca-965930e5-source-fidelity-01",
      "claims": [],
      "completed_at": null,
      "generator": "trusted-rolling-source-admission-v1",
      "inputs": [
        "problem-library/records/canonical-problems.jsonl",
        "https://www.unsolvedmath.com/problems/OPG-48715"
      ],
      "lifecycle": "planned",
      "method": "discovery",
      "objective": "Close the source-fidelity obligation before attempting the frozen root statement.",
      "obligation_graph_id": "graph:um-opg-48715-sub-atomic-product-of-funcoids-is-a-ca-965930e5-v1",
      "problem_contract_sha256": "545e1a000828f93db74a0b6d74f96ebeeb8ab971ebfb4f2eb3726137a0f72f73",
      "problem_id": "problem:um-opg-48715-sub-atomic-product-of-funcoids-is-a-ca-965930e5",
      "route_id": "route:um-opg-48715-sub-atomic-product-of-funcoids-is-a-ca-965930e5-source-fidelity",
  ...
  "obligation_graphs": [
    {
      "attempt_id": "attempt:um-opg-48715-sub-atomic-product-of-funcoids-is-a-ca-965930e5-source-fidelity-01",
      "graph_id": "graph:um-opg-48715-sub-atomic-product-of-funcoids-is-a-ca-965930e5-v1",
      "obligations": [
        {
          "dependencies": [
            "obligation:um-opg-48715-sub-atomic-product-of-funcoids-is-a-ca-965930e5-statement-fidelity"
          ],
          "kind": "root_claim",
          "obligation_id": "obligation:um-opg-48715-sub-atomic-product-of-funcoids-is-a-ca-965930e5-root",
          "statement": {
            "formal_declaration": null,
            "language": "en",
            "text": "Conjecture In the category of continuous funcoids (defined similarly to the category of topological spaces) the following is a direct categorical product: - Product morphism is defined similarly to the category of topological spaces. - Product object is the sub-atomic product. - Projections are sub-atomic projections. See details, exact definitions, and attempted proofs here."
          },
          "statement_sha256": "6e4be04a94c8d1a0e573583e184b301b884d3a16ee8674c7444f83c9de529947"
        },
        {
          "dependencies": [],
          "kind": "definition",
          "obligation_id": "obligation:um-opg-48715-sub-atomic-product-of-funcoids-is-a-ca-965930e5-statement-fidelity",
          "statement": {
            "formal_declaration": null,
            "language": "en",
      ...
      "root_obligation_id": "obligation:um-opg-48715-sub-atomic-product-of-funcoids-is-a-ca-965930e5-root",
      "route_id": "route:um-opg-48715-sub-atomic-product-of-funcoids-is-a-ca-965930e5-source-fidelity"
    }
  ],
  "problem_contract": {
    ...
    "sources": [
      {
        ...
        "source_record_id": "unsolvedmath-opg-48715-339a88a688f8",
        "url": "https://www.unsolvedmath.com/problems/OPG-48715"
      },
      {
        "retrieved_at": "2026-09-02T00:06:43Z",
